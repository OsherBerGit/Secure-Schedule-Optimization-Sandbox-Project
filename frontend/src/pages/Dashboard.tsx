    ...
    const handleComplete = (id: number) => {
        settlementApi
            ...
            .then(() =>
                settlementApi
                    .getMySettlements()
                    .then((res) => setMySettlements(res.data)),
            )
            .catch((err: unknown) =>
                setSettlementsError(
                    err instanceof Error
                    ...
                    <div className="my-assignments-section">
                        ...
                        {settlementsLoading ? (
                            ...
                            <div className="no-assignments">
                                <p>
                                    No assignments yet. Check back after the
                                    next schedule run.
                                </p>
                            </div>
                        ) : (
                            <div className="dashboard-table-wrapper">
                                <table className="assignments-table">
                                    ...
                                    <tbody>
                                        {mySettlements.map((s) => (
                                            <tr key={s.id}>
                                                <td className="assignment-task-title">
                                                    {s.taskTitle}
                                                </td>
                                                <td>
                                                    <span
                        ...
                        <div className="top-row">
                            ...
                            >
                                ...
                                <div className="card-content">
                                    ...
                                    <p>
                                        Run the scheduling algorithm, review
                                        Gantt charts, and approve assignments
                                    </p>
                                </div>
                            </Link>
                        </div>
