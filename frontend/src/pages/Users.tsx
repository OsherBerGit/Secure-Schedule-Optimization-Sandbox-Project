...
const Users: React.FC = () => {
    ...
    const filteredUsers = useMemo(() => {
        return users.filter((u) => {
            ...
            const matchesDept =
                !departmentFilter || u.departmentName === departmentFilter;
            const matchesSkill =
                !skillFilter || u.skills?.some((s) => s.name === skillFilter);
                                ...
                                <tr key={u.nationalId}>
                                    ...
                                    <td className="actions-cell">
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                navigate(
                                                    `/vacations?userId=${u.id}`,
                                                    {
                                                        state: {
                                                            filterUserName: `${u.firstName} ${u.lastName}`,
                                                        },
                                                    },
                                                )
                                            }
