        ...
        <div className="modal-overlay">
            <div className="modern-modal-card" style={{ maxWidth: '500px', width: '90%' }}>
                <div className="modal-header">
                    <h2><GitMerge size={22} className="text-primary" /> Add Task Constraint</h2>
                ...
                <form onSubmit={handleSubmit} className="modern-modal-form">
                        ...
                        <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
                            <div className="modern-form-group">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="" disabled>-- Select First Task --</option>
                            ...
                            <div className="modern-form-group">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="" disabled>-- Select Dependent Task --</option>
                                    {tasks.map(t => <option key={t.id} value={t.id}>{t.title}</option>)}
                                </select>
                            </div>
                    ...
                    <div className="modal-actions" style={{ padding: '1.5rem 2rem', background: '#f8fafc', borderTop: '1px solid #e2e8f0' }}>
                        <button type="button" className="btn-cancel" onClick={onClose} style={{ fontSize: '1rem', padding: '0.75rem 1.5rem' }}>
                            Cancel
                        </button>
                        <button type="submit" className="btn-submit" style={{ fontSize: '1rem', padding: '0.75rem 1.5rem' }}>
                            Create Constraint
                        </button>
                    </div>
                </form>
