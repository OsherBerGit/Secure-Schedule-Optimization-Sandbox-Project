...
interface SchedulingConfigurationFormProps {
    ...
    onSubmit: (
        config: Omit<SchedulingConfiguration, "id" | "isActive">,
    ) => void;
    onCancel: () => void;
    isLoading: boolean;
}
...
const SchedulingConfigurationForm: React.FC<
    SchedulingConfigurationFormProps
> = ({ initialConfig = DEFAULT_CONFIG, onSubmit, onCancel, isLoading }) => {
