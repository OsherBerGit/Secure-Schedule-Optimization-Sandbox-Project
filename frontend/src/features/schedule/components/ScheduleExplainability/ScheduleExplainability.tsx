        ...
        <div className="ex-container">
            ...
            <div className="ex-table-wrapper">
                <table className="ex-table">
                    ...
                    <tbody>
                        {failures.map(unscheduledTask => (
                            <tr key={unscheduledTask.taskId} className="ex-tr">
                                <td className="ex-td">
                                    <div className="ex-task-box">
                                        <span className="ex-task-name">{unscheduledTask.taskName}</span>
                                        <span className="ex-task-id">ID: #{unscheduledTask.taskId}</span>
                                    </div>
                                </td>
                                <td className="ex-td">
                                    <div className="ex-reason-box">
                                        <ChevronRight size={14} className="ex-chevron" />
                                        <span className="ex-reason-text">{formatReason(unscheduledTask.reason)}</span>
                                    </div>
                                </td>
                            </tr>
                        ))}
