...
class ConstraintProgrammingStrategyTest {
    ...
    void testSimpleSchedule() {
        ...
        AlgoUser user = new AlgoUser(1L, List.of(availability), 5, Set.of(100L), Collections.emptyList());

        // Create 1 Task
        AlgoTask task = new AlgoTask(101L, 2, LocalDateTime.now().plusDays(2), 1, Set.of(100L), Collections.emptyList());
