 ...
 * @param requiredRoleIds      Set of role IDs a worker must hold to be eligible
 * @param predecessorTaskIds   IDs of tasks that must be completed before this one starts
 */
